...
<div class="corpo">
  <h2>Relatório de Ordem de Serviço Cancelada</h2>
...
<?php
include 'conexao.php';
$sql = mysqli_query($con,"SELECT * FROM os WHERE situacao = 'Em análise'");
...
<?php 
$searc= mysqli_query ($con,"SELECT valor FROM os WHERE situacao = 'Em análise'")  or die (mysql_error());
