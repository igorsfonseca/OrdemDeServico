...
include 'conexao.php';
  ...
  $situacao = "Aberto";
	...
	$query = mysqli_query($con, "INSERT INTO os (cliente,cpf,endereco,cep,telefone,email,servico,valor,atividades,data) 
		VALUES ('$cliente','$cpf','$endereco','$cep','$telefone','$email','$servico','$valor','$atividades','$data')");
